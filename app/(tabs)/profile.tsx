...
export default function ProfileScreen() {
  ...
  const loadProfile = async () => {
    try {
      console.log('[Profile] Fetching user profile data from /api/users/me');
  ...
  const handleSaveProfile = async () => {
    try {
      console.log('[Profile] Saving profile changes to /api/users/me', profile);
      setLoading(true);
      const { authenticatedPut } = await import('@/utils/api');
      await authenticatedPut('/api/users/me', {
        name: profile.name,
            ...
            <>
              ...
              <View style={styles.buttonRow}>
                <TouchableOpacity
                  ...
                  onPress={() => {
                    console.log('Profile: User cancelled editing');
                    setEditing(false);
                    loadProfile();
                  }}
                >
